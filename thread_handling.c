...
/*   Updated: 2018/04/14 17:19:27 by cvermand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_screen		**init_tmp_screens_info(t_screen **screens,
		t_env *env, int nbr_scr)
{
	int		i;
...
t_screen		**init_args(t_screen **screens, int nbr_scr, t_env *env)
{
	...
	init_arg_limits(
			env->screen[nbr_scr]->min_x + env->screen[nbr_scr]->width / 2,
